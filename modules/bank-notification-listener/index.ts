 ...
 * @returns true si el paquete de Cashy esta autorizado como oyente
 */
...
/**
 * Abre la pantalla de sistema "Acceso a notificaciones" para que el
 * usuario autorice a Cashy como oyente de notificaciones.
 */
...
/**
 * Recupera y vacia las notificaciones acumuladas en segundo plano por el
 * servicio nativo mientras la aplicacion estuvo cerrada.
...
/**
 * Suscribe un callback a las notificaciones recibidas en tiempo real
 * mientras la aplicacion esta activa en primer plano.
