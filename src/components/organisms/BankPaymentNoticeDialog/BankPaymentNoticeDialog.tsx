 ...
 * si desea registrar una notificacion de pago movil como ingreso unico.
 * Muestra monto en bolivares, equivalencia en moneda base y concepto editable.
 */
 ...
 * @returns Dialogo modal centrado o null sin notificacion activa
 */
