/**
 * Hook useBankPayments: sincroniza y expone las notificaciones bancarias
 * de pago movil pendientes de confirmar, permitiendo registrarlas como
 * ingresos unicos en SQLite o descartarlas.
 */
 ...
 * @returns Estado de notificaciones bancarias y metodos de confirmacion
 */
export function useBankPayments(): UseBankPaymentsResult {
  ...
  const refresh = useCallback(async (): Promise<void> => {
    ...
    const items = await getPendingBankNotifications()
    setQueue(items)
  }, [])
