/**
 * Almacenamiento local de notificaciones bancarias pendientes de confirmacion.
 * Persiste las transacciones capturadas para que el usuario pueda revisarlas
 * al abrir la aplicacion o en primer plano.
 */
...
/**
 * Obtiene la lista de notificaciones bancarias pendientes de revision.
...
/**
 * Agrega una notificacion bancaria a la cola de pendientes, deduplicando por contenido.
